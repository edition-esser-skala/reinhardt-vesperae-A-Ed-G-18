...
MagnificatOrgano = {
  \relative c {
    ...
    a h1
    e1.
    \mvTr cis1.\pE-\solo %110
    h
    ais
    h
    eis
    fis1 gis2 %115
    \whOn a8*2 h \whOff cis2 cis,
    fis1.
    fis1 gis2
    a1 fis2
    eis1 fis2~ %120
    ...
    d e1 %185
    a,1.
    \clef bass \mvTr a\fE-\tutti
    h1 a2
    gis1 a2
    d, e1 %190
    a,2 \clef "treble_8" e''1
    d1 cis2
    h1 e2
    cis a1
    h e2~ %195
